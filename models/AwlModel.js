...
const AwlSchema = new mongoose.Schema({
    ...
    weight4: Number,
    category4: String,
    subcategories4: String,
    subsubcategories4: String,
    otherSubsubcategories4: String,
    numberOfBags4: Number,
    perbagprice4: Number,
    productValue4: Number,
    perKgRate4: Number,
    loadingCharger4: Number,
    cgst4: Number,
    sgst4: Number,
    weight4OfTruck4: Number,
    totalValue4: Number,
    totalWeight4: Number,
    perqtlrate4: Number,
    totalamount4: Number,
